    ...
    <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
      <div className='bg-[#f8f9ff] shadow-lg w-full max-w-lg mx-4 rounded-lg p-4'>
        <div className='flex justify-between items-center px-6 py-4 border-b border-[#333]'>
          <h2 className='text-xl text-[#283299] font-semibold'>Create Account</h2>
          <button className='text-gray-500 text-2xl hover:text-gray-800' onClick={() => navigate('/')}>
            &times;
          </button>
        </div>
        <form className='p-6' onSubmit={signup}>
          <div className='mb-4'>
          ...
          <button
            type='submit'
            className='w-full bg-[#414bbd] text-[#f5f5f5] rounded-lg py-3 mt-4 hover:bg-[#343c94] cursor-pointer'
          >
            Sign Up
          </button>
          ...
          <p className='justify-center flex pt-4'>
            ...
            <span onClick={() => navigate('/login')} className='cursor-pointer text-[#414bbd] px-2'>
              Sign in
            </span>
          </p>
        </form>
